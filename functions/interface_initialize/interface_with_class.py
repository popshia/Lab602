...
########################################### Create Window ############################################
main_window = tk.Tk()
main_window.geometry("1800x1200")
frame = tk.Frame(main_window)

##################################### Window Title & Frame Sizing ####################################
main_window.title("Lab602")
frame.pack(fill=BOTH, expand=True)
frame.columnconfigure(8, weight=1)
frame.columnconfigure(9, pad=5)
frame.rowconfigure(10, weight=1)
frame.rowconfigure(13, pad=5)
...
checkBoxFrame = LabelFrame(frame, text='Check Boxes', font=checkBoxFont)
...
videoFrame = LabelFrame(frame, text='Video Player', font=videoLabelFont)
...
buttonFrame = LabelFrame(frame, text='Informations', font=informationFont)
